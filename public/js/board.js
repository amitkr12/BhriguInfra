...
function showFeaturesContainer() {
    ...
    <div class="section-header">
                     <h1 class="section-title text-center">
                        <span> FirmsData, </span> Making data available & secure for Board Communications
                     </h1>
                  </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="hOne">
                      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#cOne" aria-expanded="true" aria-controls="cOne">
                        Why you should use Virtual Data Room (VDR) for Board Communications:
                      </button>
                    </h2>
                    <div id="cOne" class="accordion-collapse collapse show" aria-labelledby="hOne" data-bs-parent="#accordionCentral">
                      <div class="accordion-body-mob">
                         <div class="row">
                            <div class="col-md-5">
                               <ul>
                                 <li> VDR in Board Discussions allows to store & share large datasets with members </li>
                                 <li> It reduces the chance of Data security breaches which may have negative impact  </li>
                                 <li> VDR in Board Communications also reduces hassles of organizing all data at one place </li>
                                 <li> Sending confidential data via email or post may lead to data theft </li>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="hThree">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#cThree" aria-expanded="false" aria-controls="cThree">
                        FirmsData VDR for Board Communication ensures high level of security and compliances:
                      </button>
                    </h2>
